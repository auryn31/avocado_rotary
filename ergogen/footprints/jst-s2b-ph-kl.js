module.exports = {
  ...
  body: (p) => `
        (footprint "Connector_JST:JST_PH_S2B-PH-K_1x02_P2.00mm_Horizontal"
            ...
            (fp_text user "+" (at 0 -1.25 ${p.rot + 90}) (layer F.SilkS)
              (effects (font (size 0.5 0.5) (thickness 0.1)))
            )
            (fp_text user "+" (at 0 -1.25 ${p.rot + 90}) (layer B.SilkS)
              (effects (font (size 0.5 0.5) (thickness 0.1)))
            )
            (pad "2" thru_hole oval (at 2 0 ${p.rot}) (size 1.2 1.75) (drill 0.75) (layers "*.Cu" "*.Mask") ${p.neg.str})
            (fp_text user "-" (at 2 -1.25 ${p.rot + 90}) (layer F.SilkS)
              (effects (font (size 0.5 0.5) (thickness 0.1)))
            )
            (fp_text user "-" (at 2 -1.25 ${p.rot + 90}) (layer B.SilkS)
              (effects (font (size 0.5 0.5) (thickness 0.1)))
            )
        )
    `,
